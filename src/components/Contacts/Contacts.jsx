...
export default function Contacts() {
  return (
    <section className={s.wrap} id="contacts">
      <Container>
        <div className={s.contacts}>
          <h2 className={s.title}>Contacts</h2>
          <p className={s.descr}>
            Let's connect! Feel free to get in touch with me!
          </p>
          <DownloadCV />
		...
		c0.6,0,1.2-0.2,1.6-0.7c0.9-0.9,0.9-2.3,0-3.2L54.5,44.8z"
              ...
              <p className={s.secondary}>MaksymMaievskyi@gmail.com</p>
            </a>
            ...
            >
              ...
              <p className={s.secondary}>
                https://www.linkedin.com/in/maksym-maievskyi/
              </p>
            </a>
            ...
            >
              ...
              <p className={s.secondary}>https://github.com/RedMaxMay</p>
            </a>
          </div>
        </div>
      </Container>
